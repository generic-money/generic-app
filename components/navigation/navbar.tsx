  ...
  (
    ...
    return (
      <header
        ref={ref}
        className={cn(
          "relative sticky top-0 z-[60] w-full border-b border-border bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:px-6",
          className,
        )}
        {...props}
      >
